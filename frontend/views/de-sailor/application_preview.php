...
<div class="data-form-area pb-120" style="padding-top: 170px; background: #001731;">
    <div class="container">
        ...
        <div class="user_info__wrap">
            <?php
            echo StepAndSupport::widget(['steps' => [1, 2, 3, 4], 'slug' => Yii::$app->getRequest()->getQueryParam('slug')])
            ?>

            <div class="row justify-content-center text-white mt-60">
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            ...
                            if ($model->qr_photo && Yii::$app->r2Storage->fileExists($model->qr_photo)) {
                                echo '<img src=' . Yii::$app->r2Storage->fileUrl . $model->qr_photo . ' alt="QR not found">';
                            } else echo '&nbsp;'
                        ...
                        <div class="col-lg-8 text-center">
                            ...
                            <h2 class="bangla_font" style="line-height: 20px; font-size: 11pt; font-weight: bold;">
                             ডাইরেক্ট এন্ট্রি সেইলর ফর ডকইয়ার্ড  পদে ভর্তির আবেদনপত্র
                            </h2>
                        ...
                        <div class="col-lg-2">
                            ...
                            //     echo '<img src=' . Yii::getAlias('@rootMediaShow') . $model->photo . ' alt="Image not found">';
                            // } else echo '&nbsp;'
                            ?>
                        </div>
                    </div>
                ...
                <div class="main-form-wrap overflow-hidden mt-4">
                    <div class="d-flex">
                        ...
                        <div class="d-flex flex-grow-1">
                            <div class="flex-shrink-0">
                                <p class="bangla_font">  প্রার্থীর পূর্ণ নাম (ইংরেজী) :</p>
                            </div>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="d-flex flex-grow-1">
                            <div class="flex-shrink-0">
                                <p class="bangla_font">   প্রার্থীর পূর্ণ নাম (বাংলায়) :</p>
                            </div>
                            <div class="flex-grow-1 border-bottom-dashed mx-2">
                                <?= $model->name_bangla; ?>
                            </div>
                    ...
                    <div class="d-flex  mt-3 ">
                        ...
                        <div class="d-flex flex-wrap flex-wrap flex-grow-1">
                            <div class="d-flex flex-grow-1 w-lg-50 mt-2">
                                <div class="flex-shrink-0">
                                    <p class="bangla_font">পিতার নাম (ইংরেজী) :</p>
                                </div>
                                <div class="flex-grow-1 border-bottom-dashed mx-2">
                                    <?= $model->father_name; ?>
                                </div>
                            ...
                            <div class="d-flex flex-grow-1 w-lg-50 mt-2">
                                <div class="flex-shrink-0">
                                    <p class="bangla_font">  পিতার নাম (বাংলায়) :</p>
                                </div>
                                <div class="flex-grow-1 border-bottom-dashed mx-2">
                    ...
                    <div class="d-flex mt-3">
                        ...
                        <div class="d-flex flex-wrap flex-grow-1">
                            <div class="d-flex flex-grow-1 w-lg-50 mt-2">
                                <div class="flex-shrink-0">
                                    <p class="bangla_font"> মাতার নাম (ইংরেজী) :</p>
                                </div>
                                <div class="flex-grow-1 border-bottom-dashed mx-2">
                                    <?= $model->mother_name; ?>
                                </div>
                            ...
                            <div class="d-flex flex-grow-1 w-lg-50 mt-2">
                                <div class="flex-shrink-0">
                                    <p class="bangla_font"> মাতার নাম (বাংলায়) :</p>
                                </div>
                                <div class="flex-grow-1 border-bottom-dashed mx-2">
                    ...
                    <div class="d-flex mt-3">
                        ...
                        <div class="d-flex flex-wrap flex-grow-1">
                            ...
                            <div class="d-flex flex-wrap flex-grow-1 w-100 mt-2">
                                <div class="flex-shrink-0">
                                    <p class="bangla_font">অভিভাবকের ফোন/মোবাইল:</p>
                                </div>
                                <div class="flex-grow-1 border-bottom-dashed mx-2">
                                    <?= $model->guardian_phone; ?>
                                </div>
                            </div>
                            <div class="d-flex flex-grow-1 w-lg-50 mt-2">
                                <div class="flex-shrink-0">
                        ...
                        <div class="d-flex flex-wrap flex-grow-1">
                            <div class="d-flex flex-wrap w-100 mt-2 flex-wrap">
                                <div class="flex-shrink-lg-0">
                                    <p class="bangla_font">  জন্ম তারিখ (এসএসসি সনদপত্র অনুযায়ী) :</p>
                                </div>
                                <div class="flex-grow-1 border-bottom-dashed mx-2">
                                    <strong style="color: red;"><?= $model->dob; ?></strong>
                                </div>
                            </div>
                    ...
                    <div class="d-flex mt-3">
                        ...
                        <div class="d-flex flex-wrap flex-grow-1">
                            <div class="d-flex flex-grow-1 w-50">
                                <div class="flex-shrink-0">
                                    <p class="bangla_font">জন্ম নিবন্ধন নম্বর:</p>
                                </div>
                                <div class="flex-grow-1 border-bottom-dashed mx-2">
                        ...
                        <table class="table table-bordered text-white">
                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    <td> <?= $model->candidate_type == 2 ? 'ডিপ্লোমা' : 'ট্রেড কোর্স' ?> </td>
                                    <td><?= ($model->diploma_trade_institute) ? $model->diploma_trade_institute : 'XX'; ?></td>
                                    <td colspan="1"> <?= $diploma_trade_course ?> </td>
                                    <td>XX</td>
                                    <td colspan="1"><?= ($model->diploma_trade_registration_roll) ? $model->diploma_trade_registration_roll : 'XX'; ?></td>
                                    <td>XX</td>
                                    <td>XX</td>
                                    <td>XX</td>
                                    <td><?= ($model->diploma_trade_gpa) ? $model->diploma_trade_gpa : 'XX'; ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="d-flex mt-3">
                        ...
                        <div class="d-flex flex-wrap flex-grow-1">
                            ...
                            <?php /* <div class=" w-50 border-bottom-dashed mx-2">
                                <!-- খ )  -->
                                ক )
                                <?php
                ...
                <p class="bangla_font py-2" style="color: red; text-align: center;font-size: 20px; font-weight: bold;">আবেদন জমা দেয়ার পর কোন তথ্য পরিবর্তন করা যাবে না।</p>
                    ...
                    <div class="row gy-3">
                        <div class="col-lg-6">
                            <div class="details-circular-btn d-flex justify-content-end">
                                <?php
                                echo Html::beginForm(['/de-sailor/personal-info', 'slug' => Yii::$app->getRequest()->getQueryParam('slug')], 'post', ['class' => 'd-flex'])
                                    . Html::submitButton(
                                        'তথ্য পরিবর্তন করুন ',
                                        ['class' => 'common-btn border-0 bangla_font', 'style' => 'border:none; ']
                                    )
                                    . Html::endForm();
                                ?>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="details-circular-btn d-flex justify-content-lg-right">
                                <?php
                                echo Html::beginForm(['/de-sailor/complete-application', 'slug' => Yii::$app->getRequest()->getQueryParam('slug')], 'post', ['class' => 'd-flex'])
                                    . Html::submitButton(
                                        'আবেদন জমা দিন ',
                                        ['class' => 'common-btn border-0 bangla_font', 'style' => 'border:none; ']
                                    )
