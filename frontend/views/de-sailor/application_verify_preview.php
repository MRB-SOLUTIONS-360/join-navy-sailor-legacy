                ...
                <div class="common__table mt-3">
                    <table class="table table-bordered text-white">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td> <?= $model->candidate_type == 2 ? 'ডিপ্লোমা' : 'ট্রেড' ?> </td>
                                <td><?= ($model->diploma_trade_institute) ? $model->diploma_trade_institute : 'XX'; ?></td>
                                <td colspan="2"> <?= $diploma_trade_course ?> </td>
                                <td colspan="2"><?= ($model->diploma_trade_registration_roll) ? $model->diploma_trade_registration_roll : 'XX'; ?></td>
                                <td>XX</td>
                                <td>XX</td>
                ...
                <div class="d-flex mt-3">
                    ...
                    <div class="d-flex flex-wrap flex-grow-1">
                        <div class="d-flex flex-grow-1 w-100">
                            <div class="">
                                <!-- <p class="bangla_font"> পিতা মুক্তিযোদ্ধা বানৌবাহিনীর কর্মরত / অবঃ/ মৃত সামরিক / বেসামরিক কর্মকর্তা বা কর্মচারী হলে তার বিবরণ (সংশ্লিষ্ট মূল কাগজপত্র সঙ্গে আনতে হবে)</p> -->
                                <p class="bangla_font"> মুক্তিযোদ্ধার সন্তান/ ক্ষুদ্র নৃ-গোষ্ঠী হলে তার বিবরণ (সংশ্লিষ্ট মূল কাগজপত্র সঙ্গে আনতে হবে): </p>
                            </div>
                        </div>
                        <?php /*
                        ...
                        <div class=" w-50 border-bottom-dashed mx-2">
                            ...
                            ক )
                            <?php
                             echo StaticMethod::yesNo($model->is_freedom_fighter);
                            /*
