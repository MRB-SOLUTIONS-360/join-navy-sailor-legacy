                    ...
                    <div class="row gy-3">
                        <div class="col-lg-6">
                            <div class="details-circular-btn d-flex justify-content-end">
                                <?php
                                echo Html::beginForm(['/sailor-candidate/personal-info', 'slug' => Yii::$app->getRequest()->getQueryParam('slug')], 'post', ['class' => 'd-flex'])
                                    . Html::submitButton(
                                        'তথ্য পরিবর্তন করুন ',
                        ...
                        <div class="col-lg-6">
                            <div class="details-circular-btn d-flex justify-content-lg-right">
                                <?php
                                echo Html::beginForm(['/sailor-candidate/complete-application', 'slug' => Yii::$app->getRequest()->getQueryParam('slug')], 'post', ['class' => 'd-flex'])
                                    . Html::submitButton(
                                        'আবেদন জমা দিন ',
                                        ['class' => 'common-btn border-0 bangla_font', 'style' => 'border:none; ']
                                    )
