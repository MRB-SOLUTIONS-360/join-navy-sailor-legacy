    ...
    if ($model->application_status == Constants::NO) { ?>
     <div class="form-element">
         <div class="form-serial font_kp" style="width: 100%; line-height: 0px; font-size: 20pt; text-align: center; color: red; margin-top: 50;">
             Application ID <strong><?= $model->app_unique_id; ?></strong> is cancelled Application. <br/><br/>
            Cancel Reason : <?=  strip_tags(preg_replace('/\?>$/', '',$model->reason)); ?>?>
         </div>
     </div>
 <?php
    } else {
    ?>
     ...
     <div style="width: 100%; margin-top: 5px; height: 160px;">
         ...
         <div style="width: 56%; float: left; text-align: center;">
             ...
             <h2 class="h2_padding_margin_0 font_kp" style="line-height: 17px; font-size: 12pt; font-weight: bold; "><!--নাবিক,মহিলা --> নাবিক(পুরুষ ও মহিলা) ও এমওডিসি (নৌ) পদে ভর্তির আবেদনপত্র </h2>
             ...
             <table border="1" cellspacing="0" cellpadding="5" style="border-collapse: collapse; width: 100%; font-family: Arial, sans-serif; font-size: 12px;">
                 ...
                 <tbody>
                     ...
                     <tr>
                         ...
                         <td class="font_kp" style="vertical-align: top;">অবিবাহিত সনদ (সদ্য স্বাক্ষরিত)</td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                         ...
                         <td class="font_kp" style="vertical-align: top;"> শুধুমাত্র ৮ম শ্রেণি পাস প্রার্থীদের ক্ষেত্রে স্কুল হতে পাসকৃত সনদপত্র ও পরীক্ষার মার্কশীট জমা দিতে হবে। </td>
                     </tr>
                     <tr>
                         ...
                         <td class="font_kp" style="text-align: center; vertical-align: top;" rowspan="5">ণ। </td>
                         <td class="font_kp" style="vertical-align: top;" rowspan="5">
                     ...
                     <tr class="font_kp" style="height: 200px;">
                         <td class="font_kp" style="vertical-align: top; " colspan="4">
                             ...
                             <p>- জাতীয়তা/নাগরিকত্ব সনদ, অবিবাহিত সনদ, অভিভাবকের সম্মতিসূচক সনদ স্ব স্ব ইউনিয়ন পরিষদের চেয়ারম্যান/ পৌরসভার মেয়র অথবা চেয়ারম্যান/ ওয়ার্ড কাউন্সিলর বা কমিশনার কর্তৃক স্বাক্ষরিত / প্রতিস্বাক্ষরিত হতে হবে। </p>
