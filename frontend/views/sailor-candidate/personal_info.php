...
<script>
    $(document).ready(() => {
        ...
        $('#sailors-is_child_of_naval_officer').change(function() {
            let is_naval = $(this).val();
            if (is_naval == '<?= Constants::YES ?>') {
                $('#is_naval_display').show();
            } else {
                $('#is_naval_display').hide();
                $('#sailors-naval_father_name').val('');
                $('#sailors-naval_uniform_civil').val('');
                $('#sailors-naval_office_no').val('');
                $('#sailors-naval_rank').val('');
            }
        })

        $('#sailors-is_anser_vdp').change(function() {
            let anser_vdp_value = $(this).val();
            if (anser_vdp_value == '<?= Constants::YES ?>') {
                $('#anser_vdp_display_none').show();
            } else {
                $('#anser_vdp_display_none').hide();
                $('#sailors-anser_vdp_rank').val('');
                $('#sailors-anser_vdp_office_no').val('');
            }
        })


        $('#sailors-is_freedom_fighter').change(function() {
            let is_freedom = $(this).val();
            if (is_freedom == '<?= Constants::YES ?>') {
                $('#relation_display_none').show();
            } else {
                $('#relation_display_none').hide();
                $('#sailors-freedom_fighter_relation').val('');

            }
        })

        $("#sailors-photo").change(function() {
        ...
        $('#sailors-current_district').change(function() {
            let dist = $(this).val();
            if (dist) fetchUpazilasUnionsOptions(dist, 'thana', 'sailors-current_thana');
        })
        ...
        $('#sailors-permanent_district').change(function() {
            let dist = $(this).val();
            if (dist) fetchUpazilasUnionsOptions(dist, 'thana', 'sailors-permanent_thana');
        })
