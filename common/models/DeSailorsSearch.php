...
/**
 * DeSailorsSearch represents the model behind the search form of `common\models\DeSailors`.
 */
class DeSailorsSearch extends DeSailors
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['app_unique_id', 'exam_date', 'serial_generate_date', 'serial_no', 'eligible_district', 'district', 'name', 'father_name', 'father_nid', 'father_occupation', 'mother_name', 'mother_occupation', 'current_village', 'current_word_no', 'current_union', 'current_post_office', 'current_thana', 'current_post_code', 'current_district', 'current_phone', 'permanent_village', 'permanent_union', 'permanent_word_no', 'permanent_post_office', 'permanent_thana', 'permanent_district', 'permanent_post_code', 'permanent_phone', 'guardian_name', 'guardian_relation', 'guardian_occupation', 'guardian_address', 'dob', 'age_according_to_circular', 'nationality', 'photo', 'qr_photo', 'jsc_reg_no', 'jsc_institute_name', 'jsc_passing_year', 'jsc_gpa', 'ssc_institute', 'ssc_group', 'ssc_edu_board', 'ssc_reg_no', 'ssc_roll_no', 'ssc_passing_year', 'ssc_additional_subject', 'ssc_gpa', 'hsc_dip_institute', 'hsc_dip_group', 'hsc_dip_board', 'hsc_dip_reg_no', 'hsc_dip_roll_no', 'hsc_dip_passing_year', 'hsc_dip_additional_subject', 'hsc_dip_gpa', 'ssc_edu_data', 'hsc_edu_data', 'ssc_teletalk_data', 'hsc_teletalk_data', 'experience_one_institute', 'experience_one_subject', 'experience_one_year', 'experience_one_cert_name', 'experience_two_institute', 'experience_two_subject', 'experience_two_year', 'experience_two_cert_name', 'experience_three_institute', 'experience_three_subject', 'experience_three_year', 'experience_three_cert_name', 'experience_four_institute', 'experience_four_subject', 'experience_four_year', 'experience_four_cert_name', 'naval_father_name', 'naval_office_no', 'naval_rank', 'navy_ship_etbd_retired', 'anser_vdp_rank', 'anser_vdp_office_no', 'payment_type', 'ref_id', 'validation_id', 'order_id_original', 'card_type', 'card_no', 'trans_date', 'payment_api', 'referred_by', 'reference_details', 'relationship', 'created_dt', 'updated_dt'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'serial_generate_date' => $this->serial_generate_date,
            ...
            'diploma_trade_course' => $this->diploma_trade_course,
        ...
        $query->andFilterWhere(['like', 'app_unique_id', $this->app_unique_id])
            ...
            ->andFilterWhere(['like', 'ssc_edu_board', $this->ssc_edu_board])
            ...
            ->andFilterWhere(['like', 'hsc_dip_board', $this->hsc_dip_board])
