 ...
 * @property int $candidate_type 1=>MODC Sailor
 ...
 * @property string|null $permanent_phone_de
 ...
 * @property int|null $is_departmental_candidate 1=>Yes,2=>No
 ...
 * @property int|null $cancel_application_view 1=>view, 2=>not view
 * @property int $request_for_cancel
 * @property string|null $reason
 * @property string|null $referred_by
 * @property string|null $reference_details
 * @property int|null $have_reference
 * @property string|null $relationship
 * @property string|null $reference_add_on
 * @property datetime|null $last_reference_added
 ...
 * @property int|null $agree_payment_terms
 * @property string|null $exam_center_name
 * @property string|null $academic_info_already_used_in_ssc
 * @property string|null $academic_info_already_used_in_jsc
...
class Sailors extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            // [['jsc_institute_name','jsc_reg_no','jsc_passing_year','jsc_gpa'], 'required','on'=>self::ACADEMIC_INFO_JSC],
            ...
            // naval_office_no naval_rank English input validation
            [[
                'naval_office_no',
                'naval_rank'
            ], 'onlyInputEnglishCharacterValidation', 'skipOnError' => false, 'skipOnEmpty' => false],
            ...
            // is_anser_vdp
            [['anser_vdp_rank', 'anser_vdp_office_no'], 'isAnserVdpValidation', 'skipOnError' => false, 'skipOnEmpty' => false],
            ...
            // 
            [['refund_phone', 'list_custom_filter', 'all_requested_tran_id', 'all_paid_tran_id', 'all_payment_response', 'all_payment_request','is_image_exist_check','is_qr_exist_check','reference_add_on','last_reference_added','birth_registration_no', 'name_bangla', 'father_name_bangla', 'mother_name_bangla','reason'], 'safe'],

            [['eligibility_info_id', 'candidate_type', 'candidate_designation', 'center_id', 'exam_group', 'batch_id', 'batch_config_id', 'exam_date_id', 'religion', 'gender', 'marital_status', 'ac_type_ssc', 'hsc_or_diploma', 'is_freedom_fighter', 'is_child_of_naval_officer', 'naval_uniform_civil', 'is_anser_vdp', 'is_khudro_jati_gosti', 'phase', 'is_manula_paid', 'payment_status', 'application_status', 'have_reference', 'is_online_manual', 'created_by', 'updated_by', 'is_departmental_candidate', 'freedom_fighter_relation','is_image_exist_check','is_qr_exist_check','team','cancel_application_view','request_for_cancel'], 'integer'],
            [['exam_date', 'dob', 'trans_date', 'created_dt', 'updated_dt', 'agree_payment_terms', 'exam_center_name', 'academic_info_already_used_in_ssc', 'academic_info_already_used_in_jsc', 'serial_generate_date', 'permanent_phone_de'], 'safe'],
            ...
            [['app_unique_id', 'jsc_passing_year', 'father_phone', 'mother_phone', 'guardian_phone'], 'string', 'max' => 100],
            [['birth_registration_no','serial_no', 'jsc_reg_no', 'jsc_gpa', 'ssc_group', 'ssc_reg_no', 'ssc_passing_year', 'ssc_gpa', 'hsc_dip_group', 'hsc_dip_reg_no', 'hsc_dip_roll_no', 'hsc_dip_passing_year', 'hsc_dip_gpa', 'experience_one_year', 'experience_two_year', 'experience_three_year', 'experience_four_year', 'ssc_edu_board', 'hsc_dip_board'], 'string', 'max' => 50],
            ...
            [['eligible_district', 'district',  'current_district', 'current_phone',  'permanent_district', 'permanent_phone', 'age_according_to_circular', 'nationality', 'photo', 'qr_photo', 'experience_one_subject', 'experience_one_cert_name', 'experience_two_subject', 'experience_two_cert_name', 'experience_three_subject', 'experience_three_cert_name', 'experience_four_subject', 'experience_four_cert_name', 'naval_father_name', 'naval_office_no', 'naval_rank', 'navy_ship_etbd_retired', 'anser_vdp_rank', 'anser_vdp_office_no', 'ref_id', 'card_type', 'card_no'], 'string', 'max' => 150],

            /// candidate input length validation 
            ['father_occupation', 'string', 'max' => 30, 'tooLong' => self::attributeLabelBangla()['father_occupation'] . ' ৩০ অক্ষরের বেশি হতে পারবে না।'],
            ['father_nid', 'string', 'max' => 20, 'tooLong' => self::attributeLabelBangla()['father_nid'] . ' ২০ অক্ষরের বেশি হতে পারবে না।'],
            ['mother_occupation', 'string', 'max' => 15, 'tooLong' => self::attributeLabelBangla()['mother_occupation'] . ' ১৫ অক্ষরের বেশি হতে পারবে না।'],

            [['current_village', 'permanent_village'], 'string', 'max' => 25, 'tooLong' =>  self::attributeLabelBangla()['current_village'] . ' ২৫ অক্ষরের বেশি হতে পারবে না।'],
            [['current_word_no', 'permanent_word_no'], 'string', 'max' => 15, 'tooLong' => self::attributeLabelBangla()['current_word_no'] . ' ১৫ অক্ষরের বেশি হতে পারবে না।'],
            [['current_union', 'permanent_union'], 'string', 'max' => 25, 'tooLong' => self::attributeLabelBangla()['current_union'] . ' ২৫ অক্ষরের বেশি হতে পারবে না।'],
            [['current_post_office', 'permanent_post_office'], 'string', 'max' => 20, 'tooLong' => self::attributeLabelBangla()['current_post_office'] . ' ২০ অক্ষরের বেশি হতে পারবে না।'],
            [['current_thana', 'permanent_thana'], 'string', 'max' => 20, 'tooLong' => self::attributeLabelBangla()['current_thana'] . ' ২০ অক্ষরের বেশি হতে পারবে না।'],
            [['current_post_code', 'permanent_post_code'], 'string', 'max' => 10, 'tooLong' => self::attributeLabelBangla()['current_thana'] . ' ১০ অক্ষরের বেশি হতে পারবে না।'],


            [['name_bangla', 'father_name_bangla', 'mother_name_bangla','name', 'father_name', 'mother_name',  'jsc_institute_name', 'ssc_institute', 'ssc_additional_subject', 'hsc_dip_institute', 'hsc_dip_additional_subject', 'experience_one_institute', 'experience_two_institute', 'experience_three_institute', 'experience_four_institute', 'validation_id', 'order_id_original'], 'string', 'max' => 250],
            //[['name', 'father_name', 'mother_name', 'guardian_name', 'guardian_address', 'jsc_institute_name', 'ssc_institute', 'ssc_additional_subject', 'hsc_dip_institute', 'hsc_dip_additional_subject', 'experience_one_institute', 'experience_two_institute', 'experience_three_institute', 'experience_four_institute', 'validation_id', 'order_id_original'], 'string', 'max' => 250],
            ['guardian_name', 'string', 'max' => 45, 'tooLong' => self::attributeLabelBangla()['guardian_name'] . ' ৪৫ অক্ষরের বেশি হতে পারবে না।'],
            ['guardian_occupation', 'string', 'max' => 20, 'tooLong' => self::attributeLabelBangla()['guardian_occupation'] . ' ২০ অক্ষরের বেশি হতে পারবে না।'],
            ['guardian_relation', 'string', 'max' => 20, 'tooLong' => self::attributeLabelBangla()['guardian_relation'] . ' ২০ অক্ষরের বেশি হতে পারবে না।'],
            ['guardian_address', 'string', 'max' => 100, 'tooLong' => self::attributeLabelBangla()['guardian_address'] . ' ১০০ অক্ষরের বেশি হতে পারবে না।'],

            // experience_one_institute            
            [['experience_one_institute', 'experience_two_institute'], 'string', 'max' => 40, 'tooLong' => self::attributeLabelBangla()['experience_one_institute'] . ' ৪০ অক্ষরের বেশি হতে পারবে না।'],
            [['experience_one_subject', 'experience_two_subject'], 'string', 'max' => 30, 'tooLong' => self::attributeLabelBangla()['experience_one_subject'] . ' ৩০  অক্ষরের বেশি হতে পারবে না।'],
            [['experience_one_year', 'experience_two_year'], 'string', 'max' => 4, 'tooLong' => self::attributeLabelBangla()['experience_one_year'] . ' ৪ অক্ষরের বেশি হতে পারবে না।'],
            [['experience_one_cert_name', 'experience_one_cert_name'], 'string', 'max' => 30, 'tooLong' => self::attributeLabelBangla()['experience_one_cert_name'] . ' ৩০ অক্ষরের বেশি হতে পারবে না।'],
    ...
    public function paymentTypeValidate($attribute, $params, $validator)
    {
        if (!in_array($this->$attribute, ['online'])) {
            $this->addError($attribute, 'Must be online payment');
        }
        return true;
    }
    ...
    public function jscAcademicInfoValidate($attribute, $params, $validator)
    {
        // echo $this->scenario;
        // die();
    ...
    public function isAnserVdpValidation($attribute, $params, $validator)
    {
        if ($this->is_anser_vdp == Constants::YES && empty($this->$attribute)) {
            $this->addError($attribute, self::attributeLabelBangla()[$attribute] . ' খালি রাখা যাবে না।');
        }
        return true;
    }
    ...
    public function freedomFighterRelationValidation($attribute, $params, $validator)
    {

        // if ($this->is_freedom_fighter == Constants::YES && empty($this->$attribute)) {
        //     $this->addError($attribute, self::attributeLabelBangla()[$attribute] . ' খালি রাখা যাবে না।');
        // }
        return true;
    }

    public function jscSscAcademicInfoValidate($attribute, $params, $validator)
    {
        if (empty($this->$attribute)) {
            $this->addError($attribute, self::attributeLabelBangla()[$attribute] . ' খালি রাখা যাবে না।');
        }
    ...
    {
        // if (preg_match('/[^a-zA-Z0-9_#@;!\s\.\,\(\){\}[\]\/]+/', $this->$attribute))       
        if (!empty($this->$attribute) && !preg_match("#^[a-zA-Z0-9 .@()\&\-\,\/\:\']+$#", trim(preg_replace('/[\x{200B}-\x{200D}]/u', '', $this->$attribute)))) {
            //if (!empty($this->$attribute) && !preg_match("#^[a-zA-Z0-9 .@()\&\-\,\/\:\']+$#", trim($this->$attribute))) {
    ...
    public function checkDuplicationApplicationBySameAcInformation($attribute, $params, $validator)
    {
        ...
        if ($this->scenario == self::ACADEMIC_INFO_JSC) {
            ...
            return true;
        } else if ($this->scenario == self::ACADEMIC_INFO_JSC_SSC) {
            if ($this->ssc_edu_board && $this->ssc_roll_no && $this->ssc_reg_no && $this->ssc_passing_year) {
                $check_data = self::find()
                    ->select(['id'])
                    ->where(['batch_id' => $this->batch_id])
    ...
    public static function attributeLabelBangla()
    {
        return [
            ...
            'district' => Yii::t('app', 'জেলা'),
            'name' => Yii::t('app', 'প্রার্থীর পূর্ণ নাম (ইংরেজী)'),
            ...
            'is_freedom_fighter' => Yii::t('app', 'মুক্তিযোদ্ধার সন্তান/ ক্ষুদ্র নৃ-গোষ্ঠি'),
            ...
            'list_custom_filter' => Yii::t('app', 'Custom Filter'),
            'is_image_exist_check' => Yii::t('app', 'Is Image Exist'),
            'is_qr_exist_check' => Yii::t('app', 'Is QR Exist'),
            'last_reference_added' => Yii::t('app', 'Reference Added'),
            'request_for_cancel' => Yii::t('app', 'Request For Cancel'),
    ...
    public function attributeLabels()
    {
        return [
            ...
            'exam_date' => Yii::t('app', 'Exam Date'),
            'exam_group' => Yii::t('app', 'Exam Group'),
            'exam_center_date' => Yii::t('app', 'Exam Center Date'),
            ...
            'permanent_phone_de' => Yii::t('app', 'Permanent Phone'),
            ...
            'phase' => Yii::t('app', 'Phase'),
            'payment_type' => Yii::t('app', 'পেমেন্টের ধরন'),
            'is_manula_paid' => Yii::t('app', 'Is Manula Paid'),
            'ref_id' => Yii::t('app', 'Ref ID'),
            'validation_id' => Yii::t('app', 'Validation ID'),
            'order_id_original' => Yii::t('app', 'Order Id Original'),
     ...
     * Next roll by batch 
     */
    public static function nextRollByBatchId(int $batchId, string $batch_setting_info_roll_no, $canInfo = array())
    {
        $candidate_exist = Sailors::find()
        ...
        // $roll_no = ($candidate_exist_data['sl_no'] > 1) ? ($candidate_exist_data['sl_no'] + 1) : $batch_setting_info_roll_no;
        $roll_no = ($candidate_exist_data && $candidate_exist_data['sl_no'] > 1) ? ($candidate_exist_data['sl_no'] + 1) : $batch_setting_info_roll_no;
        return ['roll_no' => $roll_no];
    }


    public static function getLastRollExamDateByDesignationCenter(int $batchId, $canInfo = array()){
        $examDateByDesig = Sailors::find()   
    ...
    {
        $sailor_batch_wise_count  = Sailors::find()
            ...
            /// ->andFilterWhere(['REGEXP', 'eligible_district', "(^|,)" . $eligible_district . "(,|$)"])
    ...
    public static function generateLog($id = null)
    {
        ...
        $data = Sailors::find()->select($application_form_fields)->where(['id' => $id])->asArray()->one();
        if ($data) {
