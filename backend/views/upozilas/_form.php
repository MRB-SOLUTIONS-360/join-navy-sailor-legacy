...
/** @var common\models\Upozilas $model */
/** @var yii\widgets\ActiveForm $form */

$this->title = $model->isNewRecord ? 'Add Upazila' : 'Update Upazila ' . $model->name;
?>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="tab-pane show active" id="custom-styles-preview">
                    ...
                    <?= $form->field($model, 'district_id')->dropDownList(Districts::getDistrictsList(), ['prompt' => 'Select ' . $model->getAttributeLabel('division')]) ?>
