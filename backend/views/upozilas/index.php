...
/** @var common\models\UpozilasSearch $searchModel */
    ...
    <div class="row">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-light-lighten p-2 mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Upazilas</li>
            </ol>
        </nav>
    </div>
                        ...
                        <?= GridView::widget([
                            ...
                            'columns' => [
                                ...
                                [
                                    ...
                                    'template' => '{update}',
                                    'urlCreator' => function ($action, Upozilas $model, $key, $index, $column) {
