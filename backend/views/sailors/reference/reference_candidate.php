                ...
                <div class="row">
                    ...
                    <div class="col col-xl-4 text-end">
                        <h1>
                            ...
                            echo Html::a($excel . ' Excel', ['/report/all-reference-candidate-excel'], ['class' => 'btn', 'title'=>'All candidate  Excel', 'target' => '_blank', 'style' => 'color: white;background-color: rebeccapurple; font-weight: bold;']);
                            echo '&nbsp;' . Html::a($pdf . ' PDF', ['/report/reference-candidate-pdf'], ['class' => 'btn', 'title'=>'PDF report with center & date', 'target' => '_blank', 'style' => 'color: white;background-color: rebeccapurple; font-weight: bold;']);
                            echo '&nbsp;' . Html::a($excel . ' Word', ['/report/reference-candidate-word'], ['class' => 'btn', 'title'=>'Word report with center & date', 'target' => '_blank', 'style' => 'color: white;background-color: rebeccapurple; font-weight: bold;']);
                            echo '&nbsp;' . Html::a($excel . ' Excel', ['/report/reference-candidate-excel'], ['class' => 'btn', 'title'=>'Excel report with center & date', 'target' => '_blank', 'style' => 'color: white;background-color: rebeccapurple; font-weight: bold;']);
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'filter' => Html::activeDropDownList($searchModel, "candidate_designation", CanDesignation::getAllDesignation(type: Constants::CANDIDATE_SAILOR), ["prompt" => "Select Type", "class" => "form-control"]),
                            ...
                            [
                                'attribute' => 'last_reference_added',
                                'label' => 'Reference Added',
                                'value' => function ($data) {
                                    return $data->last_reference_added ??''  ;
                                },
                            ],
                            ...
                            [
                                ...
                                'buttons' => [
                                    'update' => function ($url, $model) {
                                        ...
                                        return Html::a($icon, ['sailors/reference-candidate-update', 'id' => $model->id], [
