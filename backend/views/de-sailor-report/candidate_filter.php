                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            echo $form->field($model, 'designation')->widget(Select2::classname(), [
                                'data' => CanDesignation::getAllDesignation(Constants::CANDIDATE_DE_SAILOR),
                            ...
                            <div class="col-lg-2" style="text-align: right;">
                                <div class="form-group mt-2">
                                  ...
                                  <path d="M4 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H4zm0 1h8a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z"/>
                                    ...
                                    echo Html::a($pdf . ' PDF', ['/de-sailor-report/candidate-filter-pdf'], ['class' => 'btn', 'target' => '_blank', 'style' => 'color: white;background-color: rebeccapurple; font-weight: bold;']) ?>
                                    <?= Html::a($excel . ' Excel', ['/de-sailor-report/candidate-filter-excel'], ['class' => 'btn', 'style' => 'color: white;background-color: rebeccapurple; font-weight: bold;']) ?>
