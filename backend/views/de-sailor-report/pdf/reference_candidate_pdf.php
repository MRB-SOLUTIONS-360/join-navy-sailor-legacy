...
<body>
    <div class="main-wrap" style="max-width: 100%; text-align: center;">
        <h3 style="font-size: 20px; text-align: center; line-height: 1.3; text-decoration:underline"><?= strtoupper($district_full_name); ?> <br> TEAM <?= strtoupper($centerName); ?> <br> DATE: <?php echo strtoupper(date('d M Y', strtotime($ex_date))); ?>-TOTAL APPLICANT-<?= $total_candidate ?></h3>
    </div>
        ...
        <table style="width: 100%; border: 1px solid #000;  border-collapse: collapse;">
            <thead>
                <tr style="border: 1px solid #000;">
                    ...
                    <th style="border: 1px solid #000; padding: 4px 4px; font-weight: 600;">Branch</th>
                    ...
                    <th style="width:140px; border: 1px solid #000; padding: 4px 4px; font-weight: 600;">Medical Remarks</th>
                ...
                foreach ($model as $k => $val) {  ?>
                    <tr style="border: 1px solid #000;">
                        ...
                        <td style="border: 1px solid #000; padding: 4px 6px; font-weight: 200; vertical-align: top;font-size: 12px;">
                            ...
                            <span>Mob: <?= DataEncryption::dataDecrypt($val['permanent_phone']); ?></span>
                        </td>
                        <td style="border: 1px solid #000; padding: 4px 6px; font-weight: 200; vertical-align: top;font-size: 12px;">
                            <?php
