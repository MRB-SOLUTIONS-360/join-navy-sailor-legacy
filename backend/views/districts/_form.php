...
$this->title = $model->isNewRecord ? 'Add District' : 'Update District '.$model->name_en;
?>
 <!-- start page title -->
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <?=$form->field($model, 'division')->dropDownList(StaticMethod::getDivisionList(),['prompt' => 'Select ' . $model->getAttributeLabel('division')])?>
