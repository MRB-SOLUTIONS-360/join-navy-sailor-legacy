                ...
                <?php if ($sailor) {   ?>
                    <div class="col-lg-2" style="text-align: left;">
                        <div class="form-group mt-1">
                            ...
                            echo Html::a($pdf . ' PDF', ['/report/center-candidate-pdf'], ['class' => 'btn', 'target' => '_blank', 'style' => 'color: white;background-color: rebeccapurple; font-weight: bold;']) ?>
                            <?= Html::a($excel . ' Excel', ['/report/center-candidate-excel'], ['class' => 'btn', 'style' => 'color: white;background-color: rebeccapurple; font-weight: bold;']) ?>
                    ...
                    <div class="row" style="text-align: center;">
                        ...
                        <div class="col-lg-8">
                            ...
                            <!-- <h4 class="h2_padding_margin_0 font_kp h2_head_block_common" style="margin: 0px"> <? // $model->center ? 'কেন্দ্র: ' . SailorCenters::getAllCenterSession($model->center) : '' 
                                                                                                                    ?></h4> -->
                            <h4 class="h2_padding_margin_0 font_kp h2_head_block_common" style="margin: 0px"> কেন্দ্র : <?= SailorCenters::getAllCenterSession($model->center)   ?></h4>
                            <?php
                                if($model->exam_date){
                                    ?>
                                    <h4 class="h2_padding_margin_0 font_kp h2_head_block_common" style="margin: 2px"> পরীক্ষার  তারিখ: <?= $model->exam_date ?></h4>
                                    <?php
                                }
                            ?>
                        </div>
