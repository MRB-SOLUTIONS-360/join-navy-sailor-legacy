...
<div class="row">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-light-lighten p-2 mb-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">District candidate</li>
        </ol>
    </nav>
</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            echo $form->field($model, 'district')->widget(Select2::classname(), [
                                ...
                                'language' => 'en',
                                'options' => ['placeholder' => 'Select ' . $model->getAttributeLabel('district')],
                                'pluginOptions' => [
                                    'allowClear' => true,
                                ],
                            ]); ?>
                ...
                <?php if ($sailor) {   ?>
                    <div class="col-lg-2" style="text-align: left;">
                        <div class="form-group mt-1">
                            ...
                            echo Html::a($pdf . ' PDF', ['/report/district-candidate-pdf'], ['class' => 'btn', 'target' => '_blank', 'style' => 'color: white;background-color: rebeccapurple; font-weight: bold;']) ?>
                    ...
                    <div class="row" style="text-align: center;">
                        ...
                        <div class="col-lg-8">
                            ...
                            <!-- <h4 class="h2_padding_margin_0 font_kp h2_head_block_common" style="margin: 0px"> <? // $model->center ? 'কেন্দ্র: ' . SailorCenters::getAllCenterSession($model->center) : '' 
                                                                                                                    ?></h4> -->
                            <h4 class="h2_padding_margin_0 font_kp h2_head_block_common" style="margin: 0px"> জেলা : <?= ucfirst($model->district)   ?></h4>
                        </div>
                        <div class="col-lg-2"></div>
                    </div>
                <?php }  ?>
