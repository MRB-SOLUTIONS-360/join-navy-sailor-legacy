...
/** @var backend\models\SailorBatchsSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = Yii::t('app', 'Sailor Batchs');
                    ...
                    echo  GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($data) {
                                    return $data->candidate_type ? StaticMethod::candidateType($data->candidate_type):'';
                                },
                            ...
                            [
                                ...
                                'urlCreator' => function ($action, SailorBatchs $model, $key, $index, $column) {
